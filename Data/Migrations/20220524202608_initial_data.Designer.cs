...
namespace api.Data.Migrations
{
    ...
    [Migration("20220524202608_initial_data")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.HomeWork", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("api.Models.Lesson", b =>
                {
                    ...
                    b.Property<string>("Documentaion")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("api.Models.Refliction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("api.Models.Tutorial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("api.Models.Lesson", b =>
                {
                    b.HasOne("api.Models.Tutorial", "Tutorial")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("api.Models.Photo", b =>
                {
                    b.HasOne("api.Models.Skill", "Skill")
                        .WithOne("Photo")
                        .HasForeignKey("api.Models.Photo", "SkillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
